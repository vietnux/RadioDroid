...
import net.radio.streaming.interfaces.IApplicationSelected;
import net.radio.streaming.proxy.ProxySettingsDialog;

import java.net.InetAddress;
import java.net.UnknownHostException;
import java.util.Vector;

import static net.radio.streaming.ActivityMain.FRAGMENT_FROM_BACKSTACK;
