...
import net.radio.streaming.alarm.FragmentAlarm;
import net.radio.streaming.alarm.TimePickerFragment;
import net.radio.streaming.cast.CastAwareActivity;
import net.radio.streaming.interfaces.IFragmentSearchable;
import net.radio.streaming.players.PlayState;
import net.radio.streaming.players.PlayStationTask;
import net.radio.streaming.players.mpd.MPDClient;
import net.radio.streaming.players.mpd.MPDServersRepository;
import net.radio.streaming.players.selector.PlayerType;
import net.radio.streaming.service.MediaSessionCallback;
...
import static net.radio.streaming.service.MediaSessionCallback.EXTRA_STATION_UUID;
...
public class ActivityMain extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    public static final String ACTION_SHOW_LOADING = "net.radio.streaming.show_loading";
    public static final String ACTION_HIDE_LOADING = "net.radio.streaming.hide_loading";
