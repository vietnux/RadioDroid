package net.radio.streaming.database;
...
import net.radio.streaming.history.TrackHistoryDao;
import net.radio.streaming.history.TrackHistoryEntry;

import java.util.concurrent.Executor;
import java.util.concurrent.Executors;

import static net.radio.streaming.history.TrackHistoryEntry.MAX_UNKNOWN_TRACK_DURATION;
