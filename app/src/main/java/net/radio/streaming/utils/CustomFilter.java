...
/**
 * This is a copy of {@link net.radio.streaming.utils.CustomFilter} with @hide removed from delayer.
 */
public abstract class CustomFilter {
     ...
     *
     * @see #filter(CharSequence, net.radio.streaming.utils.CustomFilter.FilterListener)
     */
     ...
     * @see #publishResults(CharSequence, net.radio.streaming.utils.CustomFilter.FilterResults)
     */
    public final void filter(CharSequence constraint, net.radio.streaming.utils.CustomFilter.FilterListener listener) {
        synchronized (mLock) {
     ...
     * must be returned as a {@link net.radio.streaming.utils.CustomFilter.FilterResults} that
     * will then be published in the UI thread through
     * {@link #publishResults(CharSequence,
     * net.radio.streaming.utils.CustomFilter.FilterResults)}.</p>
     *
     ...
     * @see #filter(CharSequence, net.radio.streaming.utils.CustomFilter.FilterListener)
     * @see #publishResults(CharSequence, net.radio.streaming.utils.CustomFilter.FilterResults)
     * @see net.radio.streaming.utils.CustomFilter.FilterResults
     */
    protected abstract net.radio.streaming.utils.CustomFilter.FilterResults performFiltering(CharSequence constraint);
    ...
    protected abstract void publishResults(CharSequence constraint,
                                           net.radio.streaming.utils.CustomFilter.FilterResults results);
     ...
     * {@link net.radio.streaming.utils.CustomFilter#filter(CharSequence, net.radio.streaming.utils.CustomFilter.FilterListener)},
    ...
    private class RequestHandler extends Handler {
         ...
         * {@link net.radio.streaming.utils.CustomFilter#performFiltering} and then sending a message
            ...
            switch (what) {
                case FILTER_TOKEN:
                    ...
                    try {
                        ...
                        args.results = new net.radio.streaming.utils.CustomFilter.FilterResults();
    ...
    private class ResultsHandler extends Handler {
         ...
         * {@link net.radio.streaming.utils.CustomFilter#publishResults(CharSequence,
         * net.radio.streaming.utils.CustomFilter.FilterResults)}
    ...
    private static class RequestArguments {
         ...
         */
        net.radio.streaming.utils.CustomFilter.FilterListener listener;
    ...
    public interface Delayer {
        ...
        /**
         * @param constraint The constraint passed to {@link net.radio.streaming.utils.CustomFilter#filter(CharSequence)}
