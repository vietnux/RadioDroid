...
import static net.radio.streaming.Utils.resourceToUri;
...
public class DataRadioStation implements Parcelable {
	...
	public static final String RADIO_STATION_LOCAL_INFO_CHAGED = "net.radio.streaming.radiostation.changed";
