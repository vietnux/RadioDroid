...
import net.radio.streaming.*;
import net.radio.streaming.interfaces.IAdapterRefreshable;
import net.radio.streaming.players.PlayStationTask;
import net.radio.streaming.players.selector.PlayerType;
import net.radio.streaming.utils.RecyclerItemMoveAndSwipeHelper;
...
//            layoutAds = itemView.findViewById(R.id.layoutAds);
...
//        Log.e("Station", " == "+position + " - " +station.Name );
//        if( position == 3 ) {
//            LayoutInflater inflater = this.activity.getLayoutInflater();
//            holder.layoutAds.addView(inflater.inflate( R.layout.nativeadstemplates, null ));
//        }
    }
