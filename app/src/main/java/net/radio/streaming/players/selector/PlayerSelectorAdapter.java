package net.radio.streaming.players.selector;
...
import net.radio.streaming.players.mpd.tasks.MPDChangeVolumeTask;
import net.radio.streaming.players.mpd.tasks.MPDPauseTask;
import net.radio.streaming.players.mpd.tasks.MPDResumeTask;
import net.radio.streaming.players.mpd.tasks.MPDStopTask;
