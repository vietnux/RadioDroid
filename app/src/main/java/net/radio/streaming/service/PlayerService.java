...
import net.radio.streaming.players.RadioPlayer;
...
public class PlayerService extends JobIntentService implements RadioPlayer.PlayerListener {
    ...
    public static final String PLAYER_SERVICE_TIMER_UPDATE = "net.radio.streaming.timerupdate";
    public static final String PLAYER_SERVICE_META_UPDATE = "net.radio.streaming.metaupdate";

    public static final String PLAYER_SERVICE_STATE_CHANGE = "net.radio.streaming.statechange";
    public static final String PLAYER_SERVICE_STATE_EXTRA_KEY = "state";

    public static final String PLAYER_SERVICE_METERED_CONNECTION = "net.radio.streaming.metered_connection";
    public static final String PLAYER_SERVICE_METERED_CONNECTION_PLAYER_TYPE = "PLAYER_TYPE";

    public static final String PLAYER_SERVICE_BOUND = "net.radio.streaming.playerservicebound";
